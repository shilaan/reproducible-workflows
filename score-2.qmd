...
$$
\begin{split}
Y_{ij} = &\gamma_{00} + \gamma_{01}(\text{AVG: URM}) + \gamma_{04} (\text{Control: Private}) + \gamma_{05} (\text{AVG: Curricular diversity}) + \gamma_{06}(\text{AVG: CRI}) + \\
&\gamma_{07}(\text{AVG: Part-time job on campus}) + \gamma_{012}(\text{AVG: Female}) +  \gamma_{013}(\text{AVG: Involvement}) + \\
& \gamma_{10}(\text{Curricular diversity}) + \gamma_{11}(\text{Curricular diversity}*\text{AVG: URM}) + \gamma_{12}(\text{Curricular diversity}*\text{AVG: Curricular diversity}) + \\
&  \gamma_{13}(\text{Curricular diversity}*\text{AVG: CRI}) +  \gamma_{14}(\text{Curricular diversity}*\text{AVG: Part-time job on campus}) + \\
& \gamma_{20}(\text{CRI}) + \gamma_{21}(\text{CRI}*\text{AVG: URM}) + \gamma_{22}(\text{CRI}*\text{AVG: Curricular diversity}) +  \gamma_{23}(\text{CRI}*\text{AVG: CRI}) + \\
& \beta_{3j}(\text{Part-time job on campus}) + \beta_{8j}(\text{Native American}) + \beta_{9j}(\text{Asian}) +  \beta_{10j}(\text{African American}) + \beta_{11j}(\text{Hispanic}) + \\
& \beta_{12j}(\text{Female}) + \beta_{13j}(\text{Involvement})
\end{split}
$$
...
**Coded claim 4 text (original paper):** Table 3 reports the results of the
...
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{10}$ = 0.08|$\gamma_{10}$ = 0.08|0.07 $\le \gamma_{10} \le$ 0.09|$\gamma_{10}$ < 0.07 or $\gamma_{10}$ > 0.09|$\gamma_{10}$ = 0.11|
Test statistic|t = 4.01|t = 4.01|3.41 $\le$ t $\le$ 4.61|t < 3.41 or t > 4.61|t = 4.35 |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = .0000139|
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{20}$ = 0.14|$\gamma_{20}$ = 0.14|0.12 $\le \gamma_{20} \le$ 0.16|$\gamma_{20}$ < 0.12 or $\gamma_{20}$ > 0.16|$\gamma_{20}$ = 0.05|
Test statistic|t = 7.39|t = 7.39|6.28 $\le$ t $\le$ 8.50|t < 6.28 or t > 8.50|t = 6.20 |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = 5.86e-10|
...
**Coded claim 4 text (original paper):** The second set of results in Table 3
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{10}$ = 0.17|$\gamma_{10}$ = 0.17|0.14 $\le \gamma_{10} \le$ 0.20|$\gamma_{10}$ < 0.14 or $\gamma_{10}$ > 0.20|$\gamma_{10}$ = 0.14|
Test statistic|t = 10.40|t = 10.40|8.84 $\le$ t $\le$ 11.96|t < 8.84 or t > 11.96|t = 5.23|
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = .000000172|
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{20}$ = 0.16|$\gamma_{20}$ = 0.16|0.14 $\le \gamma_{20} \le$ 0.18|$\gamma_{20}$ < 0.14 or $\gamma_{20}$ > 0.18|$\gamma_{20}$ = 0.02|
Test statistic|t = 9.74|t = 9.74|8.28 $\le$ t $\le$ 11.20|t < 8.28 or t > 11.20|t = 2.80  |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = .00518    |
...
**Coded claim 4 text (original paper):** Additionally, the student body’s
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{05}$ = 0.31|$\gamma_{05}$ = 0.31|0.26 $\le \gamma_{05} \le$ 0.36|$\gamma_{05}$ < 0.26 or $\gamma_{05}$ > 0.36|$\gamma_{05}$ = .13|
Test statistic|t = 3.84|t = 3.84|3.26 $\le$ t $\le$ 4.42|t < 3.26 or t > 4.42|t = 2.30       |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = .0224  |
...
**Coded claim 4 text (original paper):** The last set of results reported in
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{10}$ = 0.22|$\gamma_{10}$ = 0.22|0.19 $\le \gamma_{10} \le$ 0.25|$\gamma_{10}$ < 0.19 or $\gamma_{10}$ > 0.25|$\gamma_{10}$ = 0.17|
Test statistic|t = 18.57|t = 18.57|15.78 $\le$ t $\le$ 21.36|t < 15.78 or t > 21.36|t = 6.60 |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = 4.23e-11|
...
|Criterion          |Original value|Precise reproduction|Approximate reproduction|Non-reproduction|Reproduction result| 
|--------|--------|--------|--------|--------|--------|
Coefficient   |$\gamma_{20}$ = 0.35|$\gamma_{20}$ = 0.35|0.30 $\le \gamma_{20} \le$ 0.40|$\gamma_{20}$ < 0.30 or $\gamma_{20}$ > 0.40|$\gamma_{20}$ = 0.23|
Test statistic|t = 32.28|t = 32.28|27.44 $\le$ t $\le$ 37.12|t < 27.44 or t > 37.12|t = 30.9  |
p-value       |p < .001|p < .001|.001 $\le$ p $\le$ .051|p > .051            |p = 5.35e-207|
